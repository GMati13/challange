...
describe('Dropdown', () => {
  ...
  it('displays label', () => {
  const { getByText } = render(<Dropdown label={testLabel}></Dropdown>);
  ...
  const { baseElement } = render(
    <Dropdown label={testLabel} isOpen={true} disabled>
      <DropdownItem>Item</DropdownItem>
    </Dropdown>
  );
  const element = baseElement.getElementsByClassName('menu')[0]
  ...
  const { baseElement } = render(
    <Dropdown label={testLabel} isOpen={true}>
      <DropdownItem>Item</DropdownItem>
    </Dropdown>
  );
  const element = baseElement.getElementsByClassName('menu')[0]
